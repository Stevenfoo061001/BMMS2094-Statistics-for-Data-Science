...
- Training-versus-final-test RMSE/MAPE is recorded as an overfitting check. A test-to-training RMSE ratio of 1.3 or above makes a model ineligible for final selection.
